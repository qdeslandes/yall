...
[![!][1mb]][1ml] [![!][2mb]][2ml] [![!][3mb]][3ml] [![!][4mb]][4ml] [![!][5mb]][5ml]
...
## TODO :
	* deploy :
		* get version (one of the first jobs as version is required for building library)
		* push tag
		* create release
		* update release with artifacts
	* windows : setup windows runner -> use powershell
...
* Docker build : generate all build images (`Dockerfile.build`, `Dockerfile.test` and `Dockerfile.tag`). Push them to the repository registry.
...
[5mb]: https://sonarcloud.io/api/badges/measure?key=yall&metric=sqale_debt_ratio
[5ml]: https://sonarcloud.io/dashboard?id=yall
