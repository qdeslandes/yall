"""Codacy coverage reporter for C"""

"""
    Credits to https://github.com/codacy/python-codacy-coverage/
    Modified in order to allow C coverage upload
"""
...
URL = CODACY_BASE_API_URL + '/2.0/coverage/{commit}/c'
...
def run(prog=None):
    parser = argparse.ArgumentParser(prog=prog, description='Codacy coverage reporter for C.')
